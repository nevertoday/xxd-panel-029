...
لهذا الإحباط صنعت **Panel 029**. هو لا يضع قالباً فوق الصورة؛ بل يحدد أولاً ما لا يجوز فقدانه، ثم يترجمه إلى **يعيد رسم الصورة بباستيل شمعي مسترخٍ فوق حقل ورقي أفقي منخفض التشبع**.
