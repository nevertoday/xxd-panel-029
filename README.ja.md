...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 029 Sample 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 029 Sample 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 029 Sample 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 029 Sample 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 029 additional top-bottom sample 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 029 additional top-bottom sample 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 029 additional top-bottom sample 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 029 additional top-bottom sample 4"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 029 作例 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 029 作例 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 029 作例 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 029 作例 8"></td>
  </tr>
</table>

## 3:4 上下構成作例

16:9 組とは別の独立した4点で、3:4 上下の完成キャンバスを生成。上部は現実の写真を保ち、下部は Panel 029 の原文プロンプトに従って再構成しています。英語コピーは各写真の内容・空気・含意だけから生成し、全点を個別に確認しました。

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 029 追加上下作例 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 029 追加上下作例 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 029 追加上下作例 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 029 追加上下作例 4"></td>
  </tr>
</table>
...
**Panel 029** は、原写真の核を保ちながら、次の視覚方向を目指す制作に向いています：**写真を、横長の低彩度色面に描く、力の抜けたワックスパステル画へ**。まず用途と期待する結果を確認し、そこから構図、サイズ、文字、納品形式を決めます。
...
> XXD Panel 029 でこの画像を処理して、まず最適な構図とサイズを提案して。

視覚方向を先に確認したい場合は、上の作例をご覧ください。準備ができたら[使い始める](#使い始める)へ進めます。全モードと引数は折りたたみ資料から必要に応じて確認できます。
<!-- xxd-human-intro:end -->

<!-- xxd-panel-benefit:start -->
## すぐに判断：XXD Panel 029 はあなたに合う？

| 知りたいこと | このスタイルの答え |
|---|---|
| **得られる完成作品** | 写真を、横長の低彩度色面に描く、力の抜けたワックスパステル画へ |
| **ひと目で分かる特徴** | 横長の色面 · 淡いワックスパステル · 粗い手漉き紙 · リソグラフの粒子 · 力の抜けた手書き文字 |
...
- [中国語ランタイムアダプター](references/xxd-panel-029-prompt.zh-CN.md)
- [英語ランタイムアダプター](references/xxd-panel-029-prompt.en.md)
...
画像フォルダーを直接渡すと、この兵士 Skill が同じ Panel 029 の原文美学で一括処理します。一般的なラスター形式を既定で再帰検索し、件数を報告してから、モード・サイズ・文字・言語を一度だけ確認します。各画像は内容や文言を混ぜず独立生成し、バッチ全体は一つのフラットなタスクフォルダーへ保存します。個別の失敗は記録し、後続画像を黙って省略しません。
...
/xxd-panel-029 photo.jpg --mode top-bottom --size auto --text prompt --locale ja-JP

# 左右比較：3:2 横長、文字なし
/xxd-panel-029 photo.jpg --mode left-right --size 3:2 --text none

# デザインのみ：9:16 スマートフォン縦長、日本語文字
/xxd-panel-029 photo.jpg --mode design-only --size 9:16 --text prompt --locale ja-JP
...
/xxd-panel-029 photo.jpg --mode design-only --size 3:4 --text prompt --locale ja-JP

# 正確な文言を、書き換え・翻訳・タイトル追加なしで使用
/xxd-panel-029 photo.jpg --mode design-only --size 3:4 --copy "光をここに残す" --locale ja-JP

# 2モード × 3サイズで独立した完成構図を6枚生成
/xxd-panel-029 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ja-JP

# フォルダー全体へ Panel 029 を適用し、共通設定は一度だけ解決
/xxd-panel-029 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ja-JP
